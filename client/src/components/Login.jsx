...
const Login = () => {
  ...
  return (
    <div className='fixed top-0 left-0 right-0 bottom-0 z-10 backdrop-blur-sm bg-black/30 flex justify-center items-center'>
      ...
      <motion.form onSubmit={onSubmitHandler} className='relative bg-purple-100 p-10 rounded-xl text-slate-500'
      ...
      >
        ...
        {state !=='Login'? <p className='text-sm text-blue-600 my-4 cursor-pointer'>Forget Password?</p>: <p className='my-4'></p>}
